...
FORBIDDEN = {
    403: {
        ...
        "content": {
            "application/json": {
                "example": {
                    "detail": "The server understood the request, but it refuses to execute it due "
                    "to restrictions on client access to the specified resource"
                }
            }
        },
    }
...
NOT_FOUND = {
    404: {
        ...
        "content": {
            "application/json": {
                "example": {
                    "detail": "The requested resource could not be found but "
...
REQUEST_ENTITY_TOO_LARGE = {
    413: {
        ...
        "content": {
            "application/json": {
                "example": {
                    "detail": "The uploaded files are too large. The size should not exceed 20MB."
                }
            }
        },
    }
