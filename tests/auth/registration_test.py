...
class TestRegistrationUser:
    async def test_uniq_user(self, ac: AsyncClient, session: AsyncSession):
    ...
    async def test_occupied_email(self, _create_standard_user, ac: AsyncClient, session: AsyncSession):
    ...
    async def test_invalid_input_data(self, ac: AsyncClient, session: AsyncSession):
